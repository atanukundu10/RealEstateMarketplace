    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input type='text' placeholder='Name' className='border p-3 rounded-lg' id='name' maxLength='70' minLength='10' required onChange={handleChange} value={formData.name} />
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="regularPrice" min='100000' max='100000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange}
            ...
            <div className="flex flex-col flex-1 gap-4">
                <p className='font-semibold'> Images: 
                    <span className='font-normal text-gray-600 ml-2'>The first image will be the cover (Maximum - 6)</span>
                </p>
